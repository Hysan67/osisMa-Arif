...
<template>
  <div class="min-h-screen bg-white">
    ...
    <div class="max-w-5xl mx-auto px-4 py-12">
      ...
      <!-- ➡️ Navigasi ke Bidang Selanjutnya -->
      <div class="mt-16 text-center">
        <router-link
          :to="nextBidangPath"
          class="inline-flex items-center gap-2 px-6 py-3 bg-osisBlue text-white rounded-full hover:bg-blue-700 transition-colors"
        >
...
import PhotoSlider from '@/components/ui/PhotoSlider.vue'
