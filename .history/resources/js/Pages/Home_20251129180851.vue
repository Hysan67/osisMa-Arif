     ...
     <div class="absolute inset-0 -z-5 bg-gradient-to-t from-white/30 to-white/100"></div>
      ...
      <div class="grid md:grid-cols-3 gap-8">
        <div v-for="(item, i) in programs" :key="i" class="text-center group">
          <div class="mb-4">
            <div class="w-12 h-px bg-blue-600 mx-auto group-hover:w-16 transition-all"  data-aos="fade-right" data-aos-delay="500"></div>
          </div>
          <h3 class="text-xl font-medium text-blue-600 mb-3"  data-aos="fade-down" data-aos-delay="500">{{ item.title }}</h3>
          <p class="text-gray-700"  data-aos="zoom-in-up" data-aos-delay="500">{{ item.desc }}</p>
        </div>
      </div>
      </div>
    </section>
