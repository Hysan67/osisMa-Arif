  ...
  <div class="min-h-screen bg-white py-12">
    <div class="max-w-5xl mx-auto px-4">
      ...
      <div class="text-center mb-12">
        <h1 class="text-4xl md:text-5xl font-light text-osisBlue mb-4">
          {{ bidang.title }}
        </h1>
        ...
        <div v-for="(anggota, idx) in bidang.anggota" :key="idx" class="border-b border-gray-200 pb-12">
          <div class="flex flex-col md:flex-row gap-8 items-start">
            ...
            <div class="flex-shrink-0">
              <div class="w-24 h-24 rounded-full bg-osisBlue flex items-center justify-center text-white text-2xl font-bold">
            ...
            <div class="flex-1 max-w-3xl">
              <h2 class="text-2xl font-medium text-osisBlue">{{ anggota.nama }}</h2>
              ...
              <!-- Timeline Pengalaman -->
              <div>
                <h3 class="text-xl font-medium text-osisBlue mb-3">Pengalaman Kepanitiaan</h3>
                <div class="space-y-4">
                  <div v-for="(exp, i) in anggota.pengalaman" :key="i" class="border-l-2 border-osisBlue pl-4">
