  ...
  <div class="min-h-screen bg-transparant py-16">
    <div class="max-w-5xl mx-auto px-4 py-16">
      ...
      <div class="text-center mb-20">
        ...
        <div class="w-16 h-px bg-yellow-300 mx-auto mt-6" data-aos="fade-right" data-aos-delay="500"></div>
        ...
        >
          <div class="md:flex gap-10 items-start">
            ...
            <div class="md:w-3/5">
              ...
              <p class="text-gray-500 text-sm mb-3" data-aos="fade-right" data-aos-delay="500">{{ event.date }}</p>
              <p class="text-gray-700 leading-relaxed" data-aos="fade-up" data-aos-delay="500">
                {{ event.desc }}
              </p>
            </div>
          </div>
