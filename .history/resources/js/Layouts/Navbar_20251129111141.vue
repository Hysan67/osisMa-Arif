...
<template>
   <nav
   class="bg-gradient-to-r from-blue-600 to-blue-400 text-white fixed top-0 left-0 w-full z-50 transition-all duration-300"
   :class="{
      'h-16 md:h-20': !isScrolled,
      'h-12 md:h-16 shadow-lg': isScrolled
   }"
   >
