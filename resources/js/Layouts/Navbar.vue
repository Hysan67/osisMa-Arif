            ...
            <ul class="hidden md:flex space-x-6 items-center">
                ...
                <li class="relative" ref="bidangDropdown">
                    <button
                        ...
                        :class="{
                            'text-yellow-300': desktopDropdownOpen.bidang,
                        }"
                    >
                        Bidang
                        <svg
                            ...
                            :class="{
                                'rotate-180': desktopDropdownOpen.bidang,
                            }"
                            fill="none"
                            viewBox="0 0 24 24"
                            stroke="currentColor"
                    ...
                    >
                        ...
                        <li>
                            <router-link
                                ...
                                class="block px-4 py-2 hover:bg-blue-700 transition-colors duration-200"
                                @click="closeAllDropdowns"
                                >Bidang VI – Seni & Hubungan
                                Masyarakat</router-link
                            >
                        </li>
                        <li>
                            <router-link
                ...
                <li class="relative" ref="lainnyaDropdown">
                    <button
                        ...
                        class="flex items-center hover:text-yellow-300 focus:outline-none transition-colors duration-200 py-2"
                        :class="{
                            'text-yellow-300': desktopDropdownOpen.lainnya,
                        }"
                    >
                        Lainnya
                        <svg
                            ...
                            class="ml-1 h-4 w-4 transition-transform duration-200"
                            :class="{
                                'rotate-180': desktopDropdownOpen.lainnya,
                            }"
                            fill="none"
                            viewBox="0 0 24 24"
                            stroke="currentColor"
...
const handleClickOutside = (event) => {
    ...
    if (
        lainnyaDropdown.value &&
        !lainnyaDropdown.value.contains(event.target)
    ) {
