...
const routes = [
    ...
    { path: "/artikel", name: "Artikel", component: Event },
    { path: "/artikel/:id", name: "ArtikelDetail", component: EventDetail },
    { path: "/generasi", name: "Generasi", component: Generasi },
    { path: "/pendaftaran-osis", name: "PendaftaranOSIS", component: PendaftaranOSIS },
    {
        path: "/form-aspirasi-siswa",
        name: "AspirasiSection",
        component: AspirasiSection,
    },
    {
        path: "/bidang/:id",
        name: "BidangDetail",
