        ...
        <div class="flex flex-col md:flex-row gap-6">
          ...
          <div class="md:w-2/3">
            ...
            <div class="mb-6 grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <h4 class="text-sm font-medium text-gray-700 mb-1">Kelas</h4>
                <p class="text-lg font-semibold text-gray-900">{{ anggota.kelas || '-' }}</p>
              </div>
              <div>
                <h4 class="text-sm font-medium text-gray-700 mb-1">Posisi/Jabatan</h4>
                <p class="text-lg font-semibold text-gray-900">{{ anggota.posisi }}</p>
              </div>
            </div>
...
export default {
  ...
  setup() {
    ...
    const handleImageError = (event) => {
      // event.target.src = 'https://via.placeholder.com/400x300?text=Image+Error'
    }
