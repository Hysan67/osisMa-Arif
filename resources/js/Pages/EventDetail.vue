  ...
  <div class="min-h-screen bg-transparant py-16">
    <div class="max-w-5xl mx-auto px-4 py-16">
      ...
      <article v-else>
        ...
        <div class="rounded-2xl overflow-hidden mb-16 shadow-sm" data-aos="flip-left" data-aos-delay="500">
          <div class="aspect-video bg-gray-200 flex items-center justify-center">
            <span class="text-black text-xl font-light">Dokumentasi: {{ event.title }}</span>
          </div>
        </div>

        <!-- Konten -->
        <div class="prose prose-lg max-w-none">
          <h1 class="text-5xl font-light text-blue-600 mb-4" data-aos="fade-left" data-aos-delay="500">{{ event.title }}</h1>
          <p class="text-gray-500 text-lg mb-10" data-aos="fade-right" data-aos-delay="500">{{ event.date }}</p>

          <!-- Tema -->
          <div v-if="event.theme" class="mb-12">
            <div class="pl-6 border-l-2 border-yellow-300">
              <p class="italic text-xl text-gray-800 font-light" data-aos="flip-right" data-aos-delay="500">“{{ event.theme }}”</p>
            </div>
          </div>

          <!-- Cerita -->
          <div class="space-y-6 text-gray-800 leading-relaxed" data-aos="fade-up" data-aos-delay="500">
            <p v-for="(paragraph, i) in event.story" :key="i">{{ paragraph }}</p>
          </div>

          <!-- Penutup -->
          <div class="mt-16 pt-8 border-t border-gray-100">
            <p class="text-gray-700 mb-4" data-aos="fade-left" data-aos-delay="500">
            ...
            <p class="text-3xl font-light text-blue-600" data-aos="fade-left" data-aos-delay="500">
              {{ event.closingGreeting }}
            </p>
            <p class="mt-6 text-gray-600" data-aos="fade-right" data-aos-delay="500">
            ...
            <br/>
            <!-- Tombol bagikan -->
            <div class="flex items-center gap-3 mb-10" data-aos="zoom-in" data-aos-delay="500">
              <button
                @click="shareEvent"
