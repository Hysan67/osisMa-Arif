    ...
    <div class="min-h-screen bg-transparant py-16">
        <div class="max-w-5xl mx-auto px-4 py-16">
            ...
            <div class="text-center mb-20">
                <h1
                    class="text-5xl font-light text-blue-600 mb-6"
                    data-aos="fade-right"
                    data-aos-delay="500"
                >
                    Generasi Pengurus OSIS
                </h1>
                <p
                    class="text-gray-700 max-w-3xl mx-auto text-lg"
                    data-aos="fade-left"
                    data-aos-delay="500"
                >
                    Sejak berdiri, OSIS MA Ma’arif Udanawu telah melahirkan
                    banyak generasi pemimpin yang aktif, kreatif, dan berakhlak
                    mulia.
                </p>
            </div>
            ...
            <div class="space-y-24">
                <div
                    ...
                    :key="i"
                    class="md:flex items-start gap-10"
                    :class="{ 'flex-row-reverse': i % 2 === 1 }"
                >
                    <div class="md:w-2/5 mb-8 md:mb-0 flex justify-center">
                        <div
                            class="w-40 h-40 rounded-full bg-gray-200 flex items-center justify-center text-4xl text-gray-500"
                            data-aos="flip-left"
                            data-aos-delay="500"
                        >
                            {{ gen.initials }}
                    ...
                    <div class="md:w-3/5">
                        <h2
                            class="text-3xl font-light text-blue-600 mb-4"
                            data-aos="fade-left"
                            data-aos-delay="500"
                        >
                            {{ gen.period }}
                        ...
                        <h3
                            class="text-xl font-medium text-gray-900 mb-1"
                            data-aos="fade-right"
                            data-aos-delay="500"
                        >
                            {{ gen.name }}
                        ...
                        <p
                            class="text-gray-800 mb-6 leading-relaxed"
                            data-aos="fade-up"
                            data-aos-delay="500"
                        >
                            {{ gen.desc }}
                        ...
                        <ul class="space-y-2">
                            <li
                                v-for="(item, j) in gen.highlights"
                                :key="j"
                                class="flex items-start"
                            >
                                <span
                                    class="text-blue-600 mr-3 mt-1"
                                    data-aos="zoom-out"
                                    data-aos-delay="500"
                                    >•</span
                                >
                        ...
                        <div
                            ...
                            v-if="gen.photos && gen.photos.length"
                        >
                            <div
                                class="bg-gray-200 aspect-video rounded-xl overflow-hidden flex items-center justify-center"
                                data-aos="flip-left"
                                data-aos-delay="500"
                            >
                                <img
...
const nextPhoto = (i) => {
    ...
    setTimeout(() => {
        photoIndex.value[i] =
            (photoIndex.value[i] + 1) % generations[i].photos.length;
        isFading.value[i] = false;
    }, 400);
};
