<template>
  <div class="fixed inset-0 bg-black bg-opacity-30 flex justify-center items-center z-50 p-4">
    <div class="bg-white rounded-md shadow-lg w-full max-w-7xl max-h-[80vh] flex flex-col">
      <!-- Header Modal -->
            ...
            <table class="w-full">
              <thead class="bg-gray-700 text-white">
                <tr>
                  ...
                  <th class="py-3 px-4 text-center w-24">Gambar</th>
              ...
              <tbody>
                <tr v-for="(artikel, index) in deletedArtikels" :key="artikel.id" class="even:bg-gray-50 odd:bg-white border-b hover:bg-gray-100">
                    ...
                    <div class="flex justify-center">
                      <div v-if="artikel.img" class="relative group">
                        <img 
                          ...
                          class="w-16 h-16 object-cover rounded border border-gray-200 cursor-pointer hover:opacity-80 transition"
                          @error="handleImageError"
                        >
                        <div class="absolute inset-0 bg-black bg-opacity-0 group-hover:bg-opacity-20 transition flex items-center justify-center opacity-0 group-hover:opacity-100 cursor-pointer">
                          <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z M15 12a3 3 0 11-6 0 3 3 0 016 0z"></path>
                          </svg>
                        </div>
                      </div>
                      <div v-else class="w-16 h-16 flex items-center justify-center bg-gray-100 rounded border border-gray-200">
                  ...
                  <td class="py-3 px-4 text-center space-x-2">
                    ...
                    <button @click="$emit('permanent-delete', artikel.id, artikel.img)" class="text-red-600 hover:text-red-700 px-3 py-1.5 border border-red-600 rounded hover:bg-red-50 transition-colors" title="Hapus Permanen">
                      <svg class="w-4 h-4 inline mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
...
function handleImageError(event) {
  event.target.src = 'data:image/svg+xml;base64,';
